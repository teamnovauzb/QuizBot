...
const sw = 1.6
const cls = (extra?: string) => `stroke-current ${extra ?? 'w-full h-full'}`

export const HomeIcon = (p: P) => (
  <svg viewBox="0 0 24 24" fill="none" strokeWidth={sw} className={cls(p.className)} strokeLinecap="round" strokeLinejoin="round">
...
export const CheckBadgeIcon = (p: P) => (
  <svg viewBox="0 0 24 24" fill="none" strokeWidth={sw} className={cls(p.className)} strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2l2.4 2 3.1-.6.6 3.1L20 9l-2 2.4.6 3.1-3.1.6L13.4 17 12 19l-2.4-2-3.1.6-.6-3.1L4 12l2-2.4-.6-3.1 3.1-.6L9.6 4 12 2z" />
...
export const IdIcon = (p: P) => (
  <svg viewBox="0 0 24 24" fill="none" strokeWidth={sw} className={cls(p.className)} strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M14 10h5" /><path d="M14 14h3" />
    <path d="M5.5 17c0.5-1.5 2-2.5 3.5-2.5s3 1 3.5 2.5" />
  </svg>
)
